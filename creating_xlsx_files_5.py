...
##                   ['B2','POLIPASTO, TINA CHICA DE ACERO INOX., DISPERSOR, BASCULAS, PLATAFORMA( GALLINA), PATIN'],# 4
                   ['E2','ANTES DE INICIAR, LIMPIE PERFECTAMENTE EL EQUIPO QUE VAYA A UTILIZAR, Y MANTENGA SU LUGAR DE TRABAJO LIMPIO, TENGA UNA FRANELA PARA EVITAR ENSUCIAR'],# 5
...
##        self.ws.merge_cells("B2:D2")  ESTA NO, POR QUE UNA VEZ SELECCIONADO EL PRODUCTO SE AÑADIRÁ EL EQUIPO A  UTILIZAR
        ...
        self.ws['A1'].font = Font(name="Berlin Sans FB Demi",color="046546", size=20)
        self.ws['B1'].font = Font(name="Chicago", color="ffffff", size=20) # Color PETRA 046546
        self.ws['B1'].fill = PatternFill("solid", fgColor="046546")
        self.ws['B1'].alignment = Alignment(horizontal="center", vertical="center")
        self.ws['F1'].font = Font(name="Albertus MT")
            # El trio del estilo
            # Equipo a utilizar
        self.ws['A2'].font = Font(color="ffffff")
        self.ws['A2'].fill = PatternFill("solid", fgColor="08bd83")
        self.ws['A2'].alignment = Alignment(horizontal="center", vertical="center")
            # ANTES DE INICIAR LIMPIE...
        self.ws['E2'].font = Font(color="ffffff")
        self.ws['E2'].fill = PatternFill("solid", fgColor="08bd83")
        self.ws['E2'].alignment = Alignment(horizontal="center", vertical="center",wrap_text= True)
            # Verifique que tenga
        self.ws['A3'].font = Font(color="000000")
        self.ws['A3'].fill = PatternFill("solid", fgColor="2cf2b3")
        self.ws['A3'].alignment = Alignment(horizontal="center", vertical="center",wrap_text= True)
            # No. Inven y Descripcion
        self.ws['A4'].font = Font(color="ffffff")
        self.ws['A4'].fill = PatternFill("solid", fgColor="000000")
        self.ws['A4'].alignment = Alignment(horizontal="center", vertical="center",wrap_text= True)
            # PICTOGRAMAS
        self.ws['B4'].font = Font(color="ffffff")
        self.ws['B4'].fill = PatternFill("solid", fgColor="000000")
        self.ws['B4'].alignment = Alignment(horizontal="center", vertical="center",wrap_text= True)
            # Verifique que tenga
        self.ws['E4'].font = Font(color="ffffff")
        self.ws['E4'].fill = PatternFill("solid", fgColor="000000")
        self.ws['E4'].alignment = Alignment(horizontal="center", vertical="center",wrap_text= True)
            # Verifique que tenga
        self.ws['F4'].font = Font(color="ffffff")
        self.ws['F4'].fill = PatternFill("solid", fgColor="000000")
        self.ws['F4'].alignment = Alignment(horizontal="center", vertical="center",wrap_text= True)
        ...
        if op1 == 'si':
            ...
            if op2 in self.lista_productos:# SE COMPRUEBA SI EL STRING INGRESADO ESTA EN EL DICCIONARIO
                ...
                self.ws['B2'].value = equipo_a_usar
                self.ws.merge_cells("B2:D2")
                self.ws['B2'].alignment = Alignment(wrap_text= True)
                ...
                for i,anadir in enumerate(self.reactivos_hoja):
                    ...
                    if anadir[0][0] == 'A' and solo_reac == 1:
